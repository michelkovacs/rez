...
public class CalculadoraVariavelEleatTest {
	...
	private void carregarTabelasBasicasParaTestes() {
		faixaVariavelDao.incluir(new FaixaVariavel("mov", 0F, 99999999F, 1F));
	...
	public void calcular2ZonasFazendoFusaoEmUmaNova() throws Exception {
		...
		CalculadoraVariavelEleat calc = new CalculadoraVariavelEleat(qtdeFusoes, qtdeMaxFusoes, zonaDao, faixaVariavelDao);
	...
	public void calcular4ZonasFazendoFusaoEmUmaNova() throws Exception {
		...
		Integer qtdeMaxFusoes = 3;
		CalculadoraVariavelEleat calc = new CalculadoraVariavelEleat(qtdeMaxFusoes, zonaDao, faixaVariavelDao);
