...
public class CarregadorDadosBasicosUtil {
	...
	public static void carregarFaixasDeVariaveis() {
		...
		dao.incluir(new FaixaVariavel("eleat", 103001F, 109000F, 1F));
		dao.incluir(new FaixaVariavel("eleat", 109001F, 115000F, 0.9F));
		dao.incluir(new FaixaVariavel("eleat", 121001F, 127000F, 0.8F));
		...
		dao.incluir(new FaixaVariavel("creleit",  0F, 56500F, 0.1F));
		dao.incluir(new FaixaVariavel("creleit", 56501F, 62150F, 0.2F));
		dao.incluir(new FaixaVariavel("creleit", 62151F, 67800F, 0.3F));
		dao.incluir(new FaixaVariavel("creleit", 67801F, 73450F, 0.4F));
		dao.incluir(new FaixaVariavel("creleit", 73451F, 79100F, 0.5F));
		dao.incluir(new FaixaVariavel("creleit", 79101F, 84750F, 0.6F));
		dao.incluir(new FaixaVariavel("creleit", 84751F, 90400F, 0.7F));
		dao.incluir(new FaixaVariavel("creleit", 90401F, 96050F, 0.8F));
		dao.incluir(new FaixaVariavel("creleit", 96051F, 101700F, 0.9F));
		dao.incluir(new FaixaVariavel("creleit", 101701F, 107350F, 1F));
		dao.incluir(new FaixaVariavel("creleit", 107351F, 118650F, 1F));
		dao.incluir(new FaixaVariavel("creleit", 118651F, 124300F, 0.9F));
		dao.incluir(new FaixaVariavel("creleit", 124301F, 129950F, 0.8F));
		dao.incluir(new FaixaVariavel("creleit", 129951F, 135600F, 0.7F));
		dao.incluir(new FaixaVariavel("creleit", 135601F, 141250F, 0.6F));
		dao.incluir(new FaixaVariavel("creleit", 141251F, 1469009F, 0.5F));
		dao.incluir(new FaixaVariavel("creleit", 146901F, 152550F, 0.4F));
		dao.incluir(new FaixaVariavel("creleit", 152551F, 146900F, 0.3F));
		dao.incluir(new FaixaVariavel("creleit", 146901F, 152550F, 0.2F));
		dao.incluir(new FaixaVariavel("creleit", 158200F, 9999999F, 0.1F));
	...
	public static void carregarDadosZonas() {
		...
		dao.incluir(new Zona(	24	,"bangu",			-22.871347f,	-43.461271f,	64200,	68000,	90000	));
		...
		dao.incluir(new Zona(	123	,"deodoro",			-22.855849f,	-43.38654f,		52190,	68000,	10000	));
		dao.incluir(new Zona(	124	,"bangu",			-22.871347f,	-43.461271f,	32018,	68000,	10000	));
		...
		dao.incluir(new Zona(	178	,"deodoro",			-22.855849f,	-43.38654f,		38579,	68000,	10000	));
		...
		dao.incluir(new Zona(	230	,"bangu",			-22.871347f,	-43.461271f,	58408,	68000,	10000	));
		dao.incluir(new Zona(	231	,"bangu",			-22.871347f,	-43.461271f,	40626,	68000,	10000	));
		dao.incluir(new Zona(	232	,"bangu",			-22.871347f,	-43.461271f,	32944,	68000,	10000	));
		dao.incluir(new Zona(	233	,"bangu",			-22.871347f,	-43.461271f,	48274,	68000,	10000	));
		dao.incluir(new Zona(	234	,"bangu",			-22.871347f,	-43.461271f,	48360,	68000,	10000	));
		dao.incluir(new Zona(	235	,"bangu",			-22.871347f,	-43.461271f,	37846,	68000,	10000	));
		dao.incluir(new Zona(	236	,"bangu",			-22.871347f,	-43.461271f,	22533,	68000,	10000	));
		dao.incluir(new Zona(	237	,"bangu",			-22.871347f,	-43.461271f,	42195,	68000,	10000	));
		dao.incluir(new Zona(	238	,"bangu",			-22.878617f,	-43.46352f,		48097,	68000,	10000	));
